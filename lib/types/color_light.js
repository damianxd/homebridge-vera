    ...
    module.newDevice = function (device) {
        ...
        var RgbLight = {
            ...
            hsv2rgbw: function(obj){
              ...
              // goes down by S linearly relative to total Intensity, which is constant.
                ...
                v = v>0?(v<1?v:1):0;
                debug('translating using the values:', h, s, v);
                if(h < 2.09439) {
                  cos_h = Math.cos(h);
            ...
            getOnState: function(){
                ...
                var status = parseInt(functions.getVariable(device.id, 'status', 'boolean'));
            ...
            setOnState: function(state){
                ...
                return functions.executeAction(params).then(function(){
                  return state;
                });
            },
            getRGB: function(fn){
            ...
            setColor: function(color){
              ...
              return functions
                ...
                .then(function(response){
                  ...
                  // functions.executeAction(params);
            ...
            setHue: function(value,service){
                ...
                debug('SAT:', saturation, 'BRIGHT:',brightness, 'Color Value:', value);
                if(isNaN(saturation)){
            ...
            .on('set', function (state, callback) {
                ...
                setTimeout(function(){
                  ...
                  if(state && config.saveBrightness){
                    // console.log('setting brightness after power state', brightness.value);
                    ...
                    // if(!state){
                    //   RgbLight.setOnState(state)
                    // }
                    RgbLight
                      .setOnState(state)
                      .then(function(state){
                        console.log("Determining Level:", state);
        ...
        service
            ...
            .on('set', function (value, callback) {
              ...
              setTimeout(function(){
                debug('Setting "hue" value for %s %s', device.name, value);
                RgbLight
                  .setHue(value,service)
                    .then(function(val){
                      // return our current value
                      callback(null, val);
                });
        ...
        functions.checkCharacteristics(device, [{
            ...
            type: 'number',
            service: rgbLight.getService(Service.Lightbulb)
          },{
            vera: 'status',
