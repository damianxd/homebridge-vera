    ...
    module.newDevice = function (device, tempDisplayUnit) {
        ...
        var Thermostat = {
            ...
            getHVACState: function(){
                ...
                temperature = parseInt(functions.getVariable(device.id, 'temperature', 'number'));
                heat = parseInt(functions.getVariable(device.id, 'heat', 'number'));
                cool = parseInt(functions.getVariable(device.id, 'cool', 'number'));
            ...
            getCurrentTemperature: function(){
                ...
                temperature = parseFloat(functions.getVariable(device.id, 'temperature', 'number'));
            ...
            getTargetTemperature: function(){
                ...
                setpoint = parseInt(functions.getVariable(device.id, 'setpoint', 'number'));
            ...
            getBatteryLevel: function () {
                var level = parseFloat(functions.getVariable(device.id, 'batterylevel', 'number'));
