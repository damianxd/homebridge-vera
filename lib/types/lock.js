module.exports = function(HAPnode, config, functions)
{
    ...
    module.newDevice = function(device)
    {
        var Lock = {
            ...
            {
                res = HAPnode.request('GET','http://'+config.veraIP+':3480/data_request?id=variableget&DeviceNum='+device.id+'&serviceId=urn:micasaverde-com:serviceId:DoorLock1=Status');
